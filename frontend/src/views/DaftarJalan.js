              ...
              >
                ...
                >
                  <tr>
                    ...
                    <td style={{ padding: '12px', width: '35%' }}>Nama Jalan</td>
                    <td style={{ padding: '12px', width: '35%' }}>Kondisi Jalan</td>
                    <td style={{ padding: '12px', width: '25%' }}>Maps</td>
                    <td style={{ padding: '12px', width: '25%' }}>Action</td>
                  </tr>
                </thead>
